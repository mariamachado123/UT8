...
// SEA MÁS APROPIADA
    ...
    private LinkedList<Comparable> etiquetas=new LinkedList<>();
    ...
    public TCamino getCaminos(){
        return this;
    }
    public void agregarVertice(Comparable etiqueta) {
        etiquetas.add(etiqueta);
    }

    public boolean contieneVertice(Comparable etiqueta) {
