...
public class TGrafoDirigido implements IGrafoDirigido {
    ...
    public TCaminos todosLosCaminos(Comparable etiquetaOrigen, Comparable etiquetaDestino) {
        ...
        Set<Comparable> visitados=new HashSet<>();
        backtrackingCaminosConCostos(etiquetaOrigen, etiquetaDestino, visitados, caminoActual, caminos);
        return  caminos;    }

    private void backtrackingCaminosConCostos(Comparable actual, Comparable destino, Set<Comparable> visitados, List<TAdyacencia> caminoActual, TCaminos caminos) {
        ...
        if (actual.equals(destino)) {
            ...
            TVertice verticeActual= (TVertice) vertices.get(actual);
            if (verticeActual!=null) {
                for (Object o:verticeActual.getAdyacentes()) {
                    TAdyacencia adyacente=(TAdyacencia) o;
    ...
    @Override
    public Collection<TVertice> bea() { //busqueda en amplitud
        Set<TVertice> visitados= new HashSet<>();
        List<TVertice> resultado= new ArrayList<>();
        for (TVertice vertice : vertices.values()) {
